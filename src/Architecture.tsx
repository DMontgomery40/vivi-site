...
import { ArrowLeft, Shield, Code, Database, Brain, Settings, Lock, Zap } from "lucide-react";
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <motion.div
                ...
                viewport={{ once: true }}
                transition={{ duration: 0.8 }}
                className="bg-gradient-to-br from-slate-900/50 to-slate-800/30 border border-slate-700/50 backdrop-blur-xl rounded-3xl p-8 hover:border-sky/30 transition-all duration-500 group"
              >
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h3 className="text-xl font-bold text-white">Traits</h3>
                </div>
                <p className="text-slate-300 leading-relaxed">
                  Capabilities declared by providers. The UI adapts to what's actually available instead of hardcoding assumptions.
                </p>
              </motion.div>
              ...
              >
                ...
                <p className="text-slate-300 leading-relaxed">
                  Interchangeable modules for transport, storage, identity, and UI. Swap them without breaking contracts.
                </p>
              </motion.div>
              ...
              >
                ...
                <p className="text-slate-300 leading-relaxed">
                  Authorization layer that decides who can do what. Different users see different capabilities based on their role.
                </p>
              </motion.div>
            </div>
          </div>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              >
                ...
                <ul className="text-slate-300 space-y-2 text-sm">
                  ...
                  <li>• PHI redacted in audit records</li>
                  <li>• Secure cookies with CSRF protection</li>
                  <li>• Time-bound elevation states</li>
                  <li>• Idempotent webhooks by default</li>
                </ul>
              </motion.div>
              ...
              >
                <div className="flex items-center gap-3 mb-4">
                  <Database className="h-6 w-6 text-sky" />
                  <h3 className="text-xl font-bold text-white">Consistent Observability</h3>
                </div>
                <ul className="text-slate-300 space-y-2 text-sm">
                  <li>• Single metrics endpoint</li>
                  <li>• One health monitor/circuit breaker</li>
                  <li>• No competing metrics stacks</li>
                  <li>• Predictable logging patterns</li>
        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-6">
            <a href="mailto:dmontg@gmail.com" className="text-slate-400 hover:text-sky transition-colors">
              <span className="text-sm">dmontg@gmail.com</span>
            </a>
          </div>
        </div>
      </footer>
